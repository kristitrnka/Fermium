...
public class Matrix3fMixin implements Matrix3fExtended {
    ...
    public int transformNormal(Direction direction) {
        ...
        return switch (direction) {
            case DOWN  -> NormI8.pack(-matrix.m01, -matrix.m11, -matrix.m21);
            case UP    -> NormI8.pack( matrix.m01,  matrix.m11,  matrix.m21);
            case NORTH -> NormI8.pack(-matrix.m02, -matrix.m12, -matrix.m22);
