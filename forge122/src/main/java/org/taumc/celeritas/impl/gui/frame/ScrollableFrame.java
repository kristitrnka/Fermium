...
import org.taumc.celeritas.impl.gui.frame.components.ScrollBarComponent;
...
public class ScrollableFrame extends AbstractFrame {
    ...
    public void setupFrame(AtomicReference<Integer> verticalScrollBarOffset, AtomicReference<Integer> horizontalScrollBarOffset) {
        ...
        if (this.canScrollHorizontal) {
            this.horizontalScrollBar = new ScrollBarComponent(new Dim2i(this.viewPortDimension.x(), this.viewPortDimension.getLimitY() + 1, this.viewPortDimension.width(), 10), ScrollBarComponent.Mode.HORIZONTAL, this.frame.dim.width(), this.viewPortDimension.width(), horizontalScrollBarOffset::set);
            this.horizontalScrollBar.setOffset(horizontalScrollBarOffset.get());
        }
        if (this.canScrollVertical) {
            this.verticalScrollBar = new ScrollBarComponent(new Dim2i(this.viewPortDimension.getLimitX() + 1, this.viewPortDimension.y(), 10, this.viewPortDimension.height()), ScrollBarComponent.Mode.VERTICAL, this.frame.dim.height(), this.viewPortDimension.height(), verticalScrollBarOffset::set, this.viewPortDimension);
    ...
    public void render(GuiGraphics drawContext, int mouseX, int mouseY, float delta) {
        if (!this.canScrollHorizontal && !this.canScrollVertical) {
            ...
            GL11.glPushMatrix();
            GL11.glTranslatef((float)this.applyOffset(this.horizontalScrollBar, 0.0F, true), (float)this.applyOffset(this.verticalScrollBar, 0.0F, true), 0.0F);
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        return this.canScrollHorizontal && this.horizontalScrollBar.mouseClicked(mouseX, mouseY, button) || this.canScrollVertical && this.verticalScrollBar.mouseClicked(mouseX, mouseY, button) || super.mouseClicked(this.applyOffset(this.horizontalScrollBar, mouseX, false), this.applyOffset(this.verticalScrollBar, mouseY, false), button);
    }

    @Override
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        return this.canScrollHorizontal && this.horizontalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY) || this.canScrollVertical && this.verticalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY) || super.mouseDragged(this.applyOffset(this.horizontalScrollBar, mouseX, false), this.applyOffset(this.verticalScrollBar, mouseY, false), button, deltaX, deltaY);
    }

    @Override
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        return this.canScrollHorizontal && this.horizontalScrollBar.mouseReleased(mouseX, mouseY, button) || this.canScrollVertical && this.verticalScrollBar.mouseReleased(mouseX, mouseY, button) || super.mouseReleased(this.applyOffset(this.horizontalScrollBar, mouseX, false), this.applyOffset(this.verticalScrollBar, mouseY, false), button);
    }

    @Override
    public boolean mouseScrolled(double mouseX, double mouseY, double verticalAmount) {
        return this.canScrollHorizontal && this.horizontalScrollBar.mouseScrolled(mouseX, mouseY, verticalAmount) || this.canScrollVertical && this.verticalScrollBar.mouseScrolled(mouseX, mouseY, verticalAmount) || super.mouseScrolled(this.applyOffset(this.horizontalScrollBar, mouseX, false), this.applyOffset(this.verticalScrollBar, mouseY, false), verticalAmount);
    }
