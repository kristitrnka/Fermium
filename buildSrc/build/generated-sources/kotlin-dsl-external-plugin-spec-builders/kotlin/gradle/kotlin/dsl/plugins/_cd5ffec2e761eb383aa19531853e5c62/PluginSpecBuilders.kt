...
package gradle.kotlin.dsl.plugins._cd5ffec2e761eb383aa19531853e5c62
...
/**
 * The `dev.kikugie` plugin group.
 */
@org.gradle.api.Generated
internal
class `DevKikugiePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `dev.kikugie`.
 */
internal
val `DevPluginGroup`.`kikugie`: `DevKikugiePluginGroup`
    get() = `DevKikugiePluginGroup`(plugins)


/**
 * The `dev.kikugie.stonecutter` plugin implemented by [dev.kikugie.stonecutter.StonecutterPlugin].
 */
internal
val `DevKikugiePluginGroup`.`stonecutter`: PluginDependencySpec
    get() = plugins.id("dev.kikugie.stonecutter")
