...
public class LWJGL2MemoryStack extends MemoryStack {
    private final org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryStack delegate;

    public LWJGL2MemoryStack(org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryStack delegate) {
