 ...
 */
package org.taumc.celeritas.lwjgl.lwjgl2.memory;

import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.encodeASCIIUnsafe;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.encodeUTF16Unsafe;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.encodeUTF8Unsafe;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memAddress;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memLengthASCII;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memLengthUTF16;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memLengthUTF8;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPointerBuffer;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutAddress;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutByte;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutDouble;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutFloat;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutInt;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutLong;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memPutShort;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.memSet;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferByte;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferDouble;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferFloat;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferInt;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferLong;
import static org.taumc.celeritas.lwjgl.lwjgl2.memory.MemoryUtilities.wrapBufferShort;
...
public class MemoryStack extends Pointer.Default implements AutoCloseable {
    ...
    private void frameOverflow() {
        System.err.println("[WARNING] Out of frame stack space (" + frames.length + ") in thread: " + Thread.currentThread());
